...
```{r, eval=FALSE}
gene_counts <- read.table("~/Documents/Teaching/Bioinfo_workshops/gene_counts.tsv", sep = "\t",row.names = 1, header = T)
metadata <- read.table("~/Documents/Teaching/Bioinfo_workshops/metadata.tsv", sep = "\t", header = T)
