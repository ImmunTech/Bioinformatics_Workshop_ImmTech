...
```{r, eval=FALSE}
gene_counts <- read.table("~/Teaching/Bioinformatics_Workshop_ImmTech/Data/2019-10-15/gene_counts.tsv", sep = "\t",row.names = 1, header = T)
metadata <- read.table("~/Teaching/Bioinformatics_Workshop_ImmTech/Data/2019-10-15/metadata.tsv", sep = "\t", header = T)
